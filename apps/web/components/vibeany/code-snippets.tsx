...
import { BuilderBlocks as BuilderBlocksBase } from '@builder.io/react';
import type { ComponentType } from 'react';

const BuilderBlocks = BuilderBlocksBase as unknown as ComponentType<any>;

const camelCase = (str: string) =>
  str.replace(/-([a-z])/g, (match) => match[1].toUpperCase());

const LOCAL_VIBEANY_ASSET_BASE = '/cdn-vibeany-assets';
const vibeAnyAsset = (filename: string) => `${LOCAL_VIBEANY_ASSET_BASE}/${filename}`;
...
export const frameworkTabs: Record<Tab, TabInfo> = {
  shopify: {
    image: vibeAnyAsset('0f577e84eb4e4aa4a69d602dd376aa11.png'),
    name: 'Shopify',
    code: (name) => dedent`
      {% comment %}
  ...
  rest: {
    name: 'REST API',
    image: vibeAnyAsset('7c16907175964f5dada038f6cceef77b.png'),
  ...
  graphql: {
    name: 'GraphQL',
    image: vibeAnyAsset('b739b409e5b94937b5b11e3cf62cfae4.png'),
    code: (name, key) => dedent`
  ...
  react: {
    name: 'React',
    image: vibeAnyAsset('2f3409f4f8b64d5f880195061aa481ab.png'),
    code: (name, key) => dedent`
  ...
  next: {
    name: 'Next',
    image: vibeAnyAsset('c6a3c58c0bde4f43b1fd6a350f491bdf.png'),
    code: (name, key) => dedent`
    import { builder, BuilderComponent } from '@builder.io/react'
  ...
  gatsby: {
    name: 'Gatsby',
    image: vibeAnyAsset('45e59fc603574e708dcb79e45ef72d02.png'),
    code: (name, key) => dedent`
      import { builder, BuilderComponent } from '@builder.io/react'
  ...
  angular: {
    name: 'Angular',
    image: vibeAnyAsset('a91e9e437203442d8ed481eef94a99dc.png'),
    code: (name, key) => dedent`
      // In your module
  ...
  vue: {
    name: 'Vue',
    image: vibeAnyAsset('7cc6d5b6fc4045d5a9f9b12ddcc65407.png'),
    code: (name, key) => dedent`
      <template>
  ...
  nuxt: {
    name: 'Nuxt',
    image: vibeAnyAsset('73f47f47e0cc46cd95dbf72c26728858.png'),
    code: (name, key) => dedent`
      <template>
        <RenderContent model="${name}" />
      </template>
  ...
  webcomponents: {
    image: vibeAnyAsset('5613cb3536be4c108b32c34bf06f1c59.png'),
    name: 'Webcomponents',
    code: (name, key) => {
      return dedent`
  ...
  javascript: {
    image: vibeAnyAsset('d09e5d3e78654f34964b8ff30988fd2e.jpg'),
    name: 'JS',
    language: 'javascript',
    code: (name, key, type) => {
      return dedent`
