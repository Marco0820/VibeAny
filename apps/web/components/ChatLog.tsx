...
export default function ChatLog({ projectId, onSessionStatusChange, onProjectStatusUpdate, startRequest, completeRequest, onPreviewEvent }: ChatLogProps) {
  ...
  const { isConnected } = useWebSocket({
    projectId,
    onMessage: (message) => {
      const rawMessage: any = message as any;
      if (rawMessage?.type === 'preview_error' || rawMessage?.type === 'preview_success') {
        onPreviewEvent?.(rawMessage);
        return;
      }
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 dark:bg-black dark:bg-opacity-70 flex items-center justify-center z-50">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="text-gray-900 dark:text-gray-100">
              <strong className="text-gray-700 dark:text-gray-300">Timestamp:</strong> {formatTime(selectedLog.timestamp)}
            </div>
            ...
            <div>
              <strong className="text-gray-700 dark:text-gray-300">Raw data:</strong>
              <pre className="bg-gray-100 dark:bg-gray-800 p-3 rounded-lg overflow-x-auto text-xs font-mono">
