            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Configure your VibeAny preferences</p>
                </div>
              </div>
              <button
                onClick={onClose}
            ...
            {activeTab === 'about' && (
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white">VibeAny</h3>
                ...
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-4">
                  <div className="text-center">
                    <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed max-w-2xl mx-auto">
                      VibeAny is an AI-powered development platform that integrates with GitHub, Supabase, and Vercel 
                ...
                <div className="text-center">
                  <div className="flex justify-center gap-6">
                    <a 
                      href="https://github.com/opactorai/VibeAny" 
                      target="_blank"
