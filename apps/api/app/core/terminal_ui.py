...
class TerminalUI:
    ...
    def ascii_logo(self):
        """Display ASCII art logo for VibeAny"""
        # Create "SHOPANY" logo with signature color
        logo_text = Text()
   ...
   _____ _                      _                    
  / ____| |                    | |                   
 | (___ | |__   ___  _ __   ___| |_ _ __ _   _ _   _ 
  \\___ \\| '_ \\ / _ \\| '_ \\ / _ \\ __| '__| | | | | | |
  ____) | | | | (_) | | | |  __/ |_| |  | |_| | |_| |
 |_____/_| |_|\\___/|_| |_|\\___|\\__|_|   \\__, |\\__, |
                                         __/ | __/ |
                                        |___/ |___/ 
        """
        logo_lines = logo_art.strip("\n").split("\n")

        logo_text.append("\n".join(logo_lines), style="rgb(182,109,77)")
        ...
        # Tagline
        tagline = Text("Ignite ideas with VibeAny. Build what you want. Deploy instantly.", style="rgb(182,109,77) bold")
