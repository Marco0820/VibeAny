...
if (!pathEntries.includes(pythonBinDir)) {
  pathEntries.unshift(pythonBinDir);
}

const updatedPath = pathEntries.join(path.delimiter);
const env = { ...process.env, API_PORT: apiPort.toString(), PATH: updatedPath };
